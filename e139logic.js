(Scratch => {
  ...
  class E139Logic {
    ...
    getInfo() {
      return {
        ...
        blocks: [
          {
		opcode: 'ifthen_value1_block',
            blockType: Scratch.BlockType.REPORTER,
            text: '[BOOLEAN] then [VALUE1],
            arguments: {
              BOOLEAN: {
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.REPORTER,
            text: '[BOOLEAN] then [VALUE1] else [VALUE2]',
            arguments: {
              BOOLEAN: {
                type: Scratch.ArgumentType.BOOLEAN
              },
    ...
    ifthen_value1_block({BOOLEAN, VALUE1}) {
      return cast.toBoolean(BOOLEAN) then VALUE1;
    }
    value1_or_value2_block({BOOLEAN, VALUE1, VALUE2}) {
      return cast.toBoolean(BOOLEAN) then VALUE1 else VALUE2;
    }
    boolean_block({MENU}) {
  ...
  Scratch.extensions.register(new E139Logic());
})(Scratch);
